...
public record class BodyDesignation : IHasId<int>
{
    ...
    {
        if (StarNum is < 0 or >= 16) return null;
        if (StellarBarycentreLength is < 1 or >= 16) return null;
        if (StellarBarycentreLength != null && StarNum < 1) return null;
        if ((int)DesignationType is < 1 or >= 32) return null;
