...
public class BodyDesignationComparer(string sysname) : IComparer<BodyDesignation?>, IComparer<IBodyData>
{
    ...
    public int Compare(BodyDesignation? x, BodyDesignation? y)
    {
        ...
        bool xhasplanet = x.DesignationType >= DesignationType.PlanetaryBody;
        bool xhasmoon1 = x.DesignationType >= DesignationType.Moon1Body;
        bool xhasmoon2 = x.DesignationType >= DesignationType.Moon2Body;
        bool xhasmoon3 = x.DesignationType >= DesignationType.Moon3Body;

        bool yhasplanet = y.DesignationType >= DesignationType.PlanetaryBody;
        bool yhasmoon1 = y.DesignationType >= DesignationType.Moon1Body;
        bool yhasmoon2 = y.DesignationType >= DesignationType.Moon2Body;
        bool yhasmoon3 = y.DesignationType >= DesignationType.Moon3Body;

        int planetcomp = Nullable.Compare(x.PlanetNum, y.PlanetNum);
        int moon1comp = Nullable.Compare(x.Moon1Num, y.Moon1Num);
        int moon2comp = Nullable.Compare(x.Moon2Num, y.Moon2Num);
        int moon3comp = Nullable.Compare(x.Moon3Num, y.Moon3Num);
