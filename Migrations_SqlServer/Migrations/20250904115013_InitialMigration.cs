        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignationType = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    BodyDesignation = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    BodyType = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    SinceVersion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UntilVersion = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SignalType = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    ValidFrom = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: true),
                    ValidTo = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: true),
                    FirstSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true),
                    LastSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FilenamePrefix = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    PrimarySchema = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateTime = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: false),
                    UpdateStartTime = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: true),
                    UpdateEndTime = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsAlphaOrBeta = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameBuild = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsOdyssey = table.Column<bool>(type: "bit", nullable: true),
                    IsHorizons = table.Column<bool>(type: "bit", nullable: true),
                    FirstSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true),
                    LastSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentJson = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHASector = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignalType = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignalSetJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SoftwareName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    SoftwareVersion = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    FirstSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true),
                    LastSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StationName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    StationType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BodyName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true),
                    LastSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true),
                    SectorId = table.Column<int>(type: "int", nullable: true, computedColumnSql: "CAST(IIF(SystemNameId >= 0x1000000000000000, (SystemNameId >> 40) - 0x100000, NULL) AS INT)"),
                    SectorAddress = table.Column<int>(type: "int", nullable: true, computedColumnSql: "CAST(IIF(SystemNameId >= 0 AND SystemNameId < 0x1000000000000000, (SystemNameId >> 40), NULL) AS INT)"),
                    PGSuffix = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "IIF(SystemNameId >= 0,CONCAT(' ',CHAR((SystemNameId >> 16 & 0x1FFFFF) % 26 + 65),CHAR(FLOOR((SystemNameId >> 16 & 0x1FFFFF) / 26) % 26 + 65),'-',CHAR(FLOOR((SystemNameId >> 16 & 0x1FFFFF) / (26 * 26)) % 26 + 65),' ',CHAR(SystemNameId >> 37 & 7 + 97),IIF(FLOOR((SystemNameId >> 16 & 0x1FFFFF) / (26 * 26 * 26)) > 0,CONCAT(FLOOR((SystemNameId >> 16 & 0x1FFFFF) / (26 * 26 * 26)), '-'),''),SystemNameId & 0xFFFF),NULL)"),
                    IsNamedSystem = table.Column<bool>(type: "bit", nullable: true, computedColumnSql: "CAST(IIF(SystemNameId < 0, 1, 0) AS BIT)"),
                    IsHASystem = table.Column<bool>(type: "bit", nullable: true, computedColumnSql: "CAST(IIF(SystemNameId >= 0x1000000000000000, 1, 0) AS BIT)"),
                    SystemAddress = table.Column<long>(type: "bigint", nullable: true, computedColumnSql: "((ModSystemAddress & 0xFFFF) << (44 - (ModSystemAddress >> 37 & 7) * 3)) | ((ModSystemAddress >> 40 & 0x7F) << (37 - (ModSystemAddress >> 37 & 7) * 3)) | ((ModSystemAddress >> 16 & 0x7F) << (30 - (ModSystemAddress >> 37 & 7) * 2)) | ((ModSystemAddress >> 47 & 0x3F) << (24 - (ModSystemAddress >> 37 & 7) * 2)) | ((ModSystemAddress >> 23 & 0x7F) << (17 - (ModSystemAddress >> 37 & 7) * 1)) | ((ModSystemAddress >> 53 & 0x7F) << (10 - (ModSystemAddress >> 37 & 7) * 1)) | ((ModSystemAddress >> 16 & 0x7F) << 3) | (ModSystemAddress >> 37 & 7)"),
                    SysAddr_PGSuffix = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "CONCAT(' ',CHAR((ModSystemAddress >> 16 & 0x1FFFFF) % 26 + 65),CHAR(FLOOR((ModSystemAddress >> 16 & 0x1FFFFF) / 26) % 26 + 65),'-',CHAR(FLOOR((ModSystemAddress >> 16 & 0x1FFFFF) / (26 * 26)) % 26 + 65),' ',CHAR(ModSystemAddress >> 37 & 7 + 97),IIF(FLOOR((ModSystemAddress >> 16 & 0x1FFFFF) / (26 * 26 * 26)) > 0,CONCAT(FLOOR((ModSystemAddress >> 16 & 0x1FFFFF) / (26 * 26 * 26)), '-'),''),ModSystemAddress & 0xFFFF)"),
                    NameSysAddr_PGSuffix = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "CONCAT(' ',CHAR((NameModSystemAddress >> 16 & 0x1FFFFF) % 26 + 65),CHAR(FLOOR((NameModSystemAddress >> 16 & 0x1FFFFF) / 26) % 26 + 65),'-',CHAR(FLOOR((NameModSystemAddress >> 16 & 0x1FFFFF) / (26 * 26)) % 26 + 65),' ',CHAR(NameModSystemAddress >> 37 & 7 + 97),IIF(FLOOR((NameModSystemAddress >> 16 & 0x1FFFFF) / (26 * 26 * 26)) > 0,CONCAT(FLOOR((NameModSystemAddress >> 16 & 0x1FFFFF) / (26 * 26 * 26)), '-'),''),NameModSystemAddress & 0xFFFF)"),
                    SysAddr_SectorAddress = table.Column<int>(type: "int", nullable: true, computedColumnSql: "CAST(ModSystemAddress >> 40 AS INT)"),
                    NameSysAddr_SectorAddress = table.Column<int>(type: "int", nullable: true, computedColumnSql: "CAST(NameModSystemAddress >> 40 AS INT)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayTimestamp = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemiMajorAxisScale = table.Column<short>(type: "smallint", nullable: false),
                    IsRejected = table.Column<bool>(type: "bit", nullable: true),
                    ValidFrom = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: true),
                    ValidTo = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: true),
                    FirstSeen = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayTimestamp = table.Column<DateTime>(type: "datetime2(6)", precision: 6, nullable: true),
                    IsBad = table.Column<bool>(type: "bit", nullable: true),
                    ProcessedVersion = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
